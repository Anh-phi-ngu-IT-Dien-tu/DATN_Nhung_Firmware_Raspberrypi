...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dealOOSPushButton = QtWidgets.QPushButton(self.shelfStatusGroupBox)
        self.dealOOSPushButton.setGeometry(QtCore.QRect(20, 350, 151, 28))
        self.dealOOSPushButton.setCheckable(False)
        self.dealOOSPushButton.setObjectName("dealOOSPushButton")
        self.wrongObjectPushButton = QtWidgets.QPushButton(self.shelfStatusGroupBox)
        self.wrongObjectPushButton.setGeometry(QtCore.QRect(190, 350, 201, 28))
        self.wrongObjectPushButton.setObjectName("wrongObjectPushButton")
        self.SOOSPushButton = QtWidgets.QPushButton(self.shelfStatusGroupBox)
        self.SOOSPushButton.setGeometry(QtCore.QRect(400, 350, 131, 28))
        self.SOOSPushButton.setObjectName("SOOSPushButton")
        ...
        self.wrongObjectCheckBox = QtWidgets.QCheckBox(self.shelfStatusGroupBox)
        self.wrongObjectCheckBox.setGeometry(QtCore.QRect(30, 70, 41, 20))
        self.wrongObjectCheckBox.setText("")
        self.wrongObjectCheckBox.setCheckable(True)
        self.wrongObjectCheckBox.setChecked(False)
        self.wrongObjectCheckBox.setObjectName("wrongObjectCheckBox")
        self.SOOSObjectCheckBox = QtWidgets.QCheckBox(self.shelfStatusGroupBox)
        self.SOOSObjectCheckBox.setGeometry(QtCore.QRect(30, 210, 41, 20))
        self.SOOSObjectCheckBox.setText("")
        self.SOOSObjectCheckBox.setCheckable(True)
        self.SOOSObjectCheckBox.setObjectName("SOOSObjectCheckBox")
        self.OOSStatusCheckBox = QtWidgets.QCheckBox(self.shelfStatusGroupBox)
        self.OOSStatusCheckBox.setGeometry(QtCore.QRect(30, 300, 41, 20))
        self.OOSStatusCheckBox.setText("")
        self.OOSStatusCheckBox.setCheckable(True)
        self.OOSStatusCheckBox.setObjectName("OOSStatusCheckBox")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dealOOSPushButton.setText(_translate("MainWindow", "Deal with OOS"))
        self.wrongObjectPushButton.setText(_translate("MainWindow", "Deal with wrong object"))
        self.SOOSPushButton.setText(_translate("MainWindow", "Deal with SOOS"))
