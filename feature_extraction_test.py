...
robot = FeatureExtraction(min_range=150, max_range=2000, point_dist_threshold=10, min_cluster_size=10, max_cluster_size=40,
                          avg_angles_lower_bound=np.deg2rad(120), avg_angles_upper_bound=np.deg2rad(160),
                          std_angles_threshold=np.deg2rad(8), min_radius=30, max_radius=40)
